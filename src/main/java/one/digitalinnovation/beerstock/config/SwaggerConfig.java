...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Stany Alex";
    private static final String CONTACT_GITHUB = "https://gtihub.com/Stany-Alex";
    private static final String CONTACT_EMAIL = "stanyalex@hotmail.com";
